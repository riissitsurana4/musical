            ...
            <div className="max-w-md w-full space-y-8">
                ...
                >
                    <div className="flex items-center justify-center">
                        <span className="text-2xl mr-3"><image src="https://cdn.bfldr.com/5H442O3W/at/pl546j-7le8zk-afym5u/Slack_Mark_Web.png?auto=webp&format=jpg" alt="Slack Logo" className="w-10 h-10" /></span>
